    ...
    const summary = summarizeIdentityPortfolio([
      {
        ...
        ledgerId: 'ledger_a',
        ledgerName: 'Example Storefront',
        organizationId: 'org_1',
        organizationName: 'Example Holdings',
        ecosystemId: 'eco_1',
        ecosystemName: 'Example Network',
        ecosystemSlug: 'example-network',
        ledgerGroupId: null,
        livemode: false,
        name: 'Creator One',
      ...
      },
      {
        ...
        linkedAt: '2026-03-13T00:00:00Z',
        ledgerId: 'ledger_c',
        ledgerName: 'Example Market EU',
        organizationId: 'org_1',
        organizationName: 'Example Holdings',
        ecosystemId: 'eco_2',
        ecosystemName: 'External Network',
        ecosystemSlug: 'external-network',
        ledgerGroupId: null,
        livemode: true,
        name: 'Creator Three',
