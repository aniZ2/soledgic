...
export const config = {
  matcher: [
     ...
     * - public folder
     * - api routes (route handlers authenticate independently via api-handler.ts;
     *   running updateSession here would double-refresh, consuming the refresh
     *   token before the route handler can use it)
