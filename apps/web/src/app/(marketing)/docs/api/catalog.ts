...
const TREASURY_RESOURCE_ENDPOINTS: ApiEndpointDoc[] = [
  ...
  },
  {
    ...
    internal: false,
    deprecated: false,
    description: 'List scoped wallets or create a consumer credit wallet.',
    source: 'supabase/functions/wallets/index.ts',
    parameters: [
      { in: 'query', name: 'owner_id', type: 'string', required: false },
      { in: 'query', name: 'owner_type', type: 'string', required: false },
      { in: 'query', name: 'wallet_type', type: "'consumer_credit' | 'creator_earnings'", required: false },
      { in: 'query', name: 'limit', type: 'number', required: false },
      { in: 'query', name: 'offset', type: 'number', required: false },
      { in: 'body', name: 'owner_id', type: 'string', required: false },
      { in: 'body', name: 'participant_id', type: 'string', required: false },
      { in: 'body', name: 'owner_type', type: 'string', required: false },
      { in: 'body', name: 'wallet_type', type: "'consumer_credit' | 'creator_earnings'", required: true },
      { in: 'body', name: 'name', type: 'string', required: false },
      { in: 'body', name: 'metadata', type: 'Record<string, unknown>', required: false },
    ],
  },
  {
    ...
    internal: false,
    deprecated: false,
    description: 'Get a wallet object by wallet id.',
    source: 'supabase/functions/wallets/index.ts',
    parameters: [
      { in: 'path', name: 'wallet_id', type: 'string', required: true },
    ],
  },
  {
    endpoint: 'wallet-entries',
    title: 'Wallet Entries',
    path: '/v1/wallets/{wallet_id}/entries',
    methods: ['GET'],
    auth: 'API key',
    internal: false,
    deprecated: false,
    description: 'List wallet ledger entries for a wallet object.',
    source: 'supabase/functions/wallets/index.ts',
    parameters: [
      { in: 'path', name: 'wallet_id', type: 'string', required: true },
      { in: 'query', name: 'limit', type: 'number', required: false },
  ...
  },
  {
    ...
    title: 'Wallet Topup',
    path: '/v1/wallets/{wallet_id}/topups',
    methods: ['POST'],
    auth: 'API key',
    internal: false,
    deprecated: false,
    description: 'Top up a wallet when its wallet type supports external funding.',
    source: 'supabase/functions/wallets/index.ts',
    parameters: [
      { in: 'path', name: 'wallet_id', type: 'string', required: true },
  ...
  },
  {
    ...
    path: '/v1/wallets/{wallet_id}/withdrawals',
    methods: ['POST'],
    auth: 'API key',
    internal: false,
    deprecated: false,
    description: 'Withdraw or debit funds from a wallet when the wallet is redeemable.',
    source: 'supabase/functions/wallets/index.ts',
    parameters: [
      { in: 'path', name: 'wallet_id', type: 'string', required: true },
      { in: 'body', name: 'amount', type: 'number', required: true },
  ...
  },
  {
    ...
    internal: false,
    deprecated: false,
    description: 'Move funds between wallets when both wallets explicitly permit transfer.',
    source: 'supabase/functions/transfers/index.ts',
    parameters: [
      { in: 'body', name: 'from_wallet_id', type: 'string', required: false },
      { in: 'body', name: 'to_wallet_id', type: 'string', required: false },
      { in: 'body', name: 'from_participant_id', type: 'string', required: false },
      { in: 'body', name: 'to_participant_id', type: 'string', required: false },
      { in: 'body', name: 'amount', type: 'number', required: true },
      { in: 'body', name: 'reference_id', type: 'string', required: true },
      { in: 'body', name: 'description', type: 'string', required: false },
      { in: 'body', name: 'metadata', type: 'Record<string, unknown>', required: false },
  ...
  },
  {
    ...
    internal: false,
    deprecated: false,
    description: 'Create a payout for a creator earnings wallet or participant.',
    source: 'supabase/functions/payouts/index.ts',
    parameters: [
      { in: 'body', name: 'wallet_id', type: 'string', required: false },
      { in: 'body', name: 'participant_id', type: 'string', required: false },
      { in: 'body', name: 'amount', type: 'number', required: true },
      { in: 'body', name: 'reference_id', type: 'string', required: true },
