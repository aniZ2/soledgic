...
import { FileText, Download, RefreshCw, CheckCircle, Info, Send, FileEdit } from 'lucide-react'
  ...
  const confirmSendCopyB = async () => {
    ...
    try {
      ...
      if (result.success && result.delivery) {
        ...
        toast.success('Copy B delivery complete', `${d.sent} sent, ${d.failed} failed, ${d.skipped} skipped.`)
        loadData()
      } else {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground">1099 Overview</h1>
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-blue-700 dark:text-blue-400 mt-1">
              ...
              Export this data and merge with your own recipient records to complete 1099 forms for filing.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-3 mb-6 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => setConfirmAction('generate-all-pdfs')}
        ...
        <button
          onClick={() => setConfirmAction('send-copy-b')}
      ...
      <ConfirmDialog
        ...
        message={`Email 1099-NEC Copy B PDFs to all recipients with $600+ in gross payments for ${taxYear}?`}
