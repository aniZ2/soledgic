  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="mt-3 text-muted-foreground">
        Stripe Connect onboarding is currently disabled. Soledgic is now wired to Finix for active payment and payout setup.
      </p>
      ...
      <div className="mt-6 rounded-lg border border-border bg-card p-5">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <li>New payment rail onboarding is handled through Finix.</li>
