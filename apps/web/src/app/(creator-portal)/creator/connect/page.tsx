  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="mt-3 text-muted-foreground">
        Connected account onboarding is currently disabled. Soledgic now uses its primary card processor for payment and payout setup.
      </p>
      ...
      <div className="mt-6 rounded-lg border border-border bg-card p-5">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          <li>Existing legacy processor data remains available for historical records.</li>
