-- ============================================================================
-- FIX: Use valid status value in create_organization_with_ledger RPC
-- Valid values: 'active', 'past_due', 'canceled', 'suspended'
-- Trial state is determined by trial_ends_at being in the future
-- ============================================================================
...
BEGIN
  ...
  -- Create organization (status='active', trial determined by trial_ends_at)
