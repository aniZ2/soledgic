-- ============================================================================
-- FIX: Use api_keys table instead of api_key column on ledgers
-- The api_key column was moved to a separate api_keys table
-- ============================================================================
...
BEGIN
  ...
  -- Create test ledger (without api_key column)
  INSERT INTO ledgers (
    id,
    organization_id,
    business_name,
  ...
  -- Create live ledger (without api_key column)
  INSERT INTO ledgers (
    id,
    organization_id,
    business_name,
  ...
  INSERT INTO api_keys (
    ...
    v_test_ledger_id,
    'Default Test Key',
    encode(digest(v_test_api_key, 'sha256'), 'hex'),
  ...
  INSERT INTO api_keys (
    ...
    v_live_ledger_id,
    'Default Live Key',
    encode(digest(v_live_api_key, 'sha256'), 'hex'),
