-- Cleanup test data before running stress tests
DO $$
DECLARE v_ledger_id UUID;
BEGIN
  SELECT id INTO v_ledger_id FROM ledgers WHERE api_key_hash = encode(sha256('sk_live_28b75b47565bed2c5c6acaa3ffe3038f0dc897a57c83a1f2'::bytea), 'hex');
  IF v_ledger_id IS NULL THEN RETURN; END IF;
