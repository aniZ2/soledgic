-- Keep the audit log trigger function's search_path valid.
-- The previous definition used a single quoted string ('public, extensions'),
-- which PostgreSQL treats as one schema name instead of two entries.
