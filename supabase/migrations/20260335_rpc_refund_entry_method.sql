-- Add p_entry_method parameter to record_refund_atomic_v2.
-- Defaults to 'processor' for refunds (processor-verified).
-- Callers can override to 'manual', 'system', or 'import'.
